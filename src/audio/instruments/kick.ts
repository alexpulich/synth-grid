...
export const triggerKick: InstrumentTrigger = (ctx, dest, time, velocity = 1, pitchOffset = 0, params) => {
  ...
  const duration = 0.2 + d * 0.8;             // 0.2-1.0s
  ...
  osc.frequency.exponentialRampToValueAtTime(30 * pitchMult, time + sweepTime);
