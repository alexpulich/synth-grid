import { NUM_ROWS, NUM_STEPS, MELODIC_ROWS, TRIG_CONDITIONS, GATE_LEVELS, GATE_LABELS } from '../types';
import { INSTRUMENTS } from '../audio/instruments';
import type { Sequencer } from '../sequencer/sequencer';
import { Knob } from './knob';
import { eventBus } from '../utils/event-bus';
import { semitoneToNoteName } from '../utils/scales';
...
import { GridEventManager } from './grid-event-manager';
...
export class GridUI {
  ...
  readonly eventManager!: GridEventManager;
  ...
  constructor(parent: HTMLElement, private sequencer: Sequencer, audioEngine: AudioEngine) {
    ...
    this.buildGrid();
    this.eventManager = new GridEventManager(
      this.container, this.cells, sequencer,
      this.cellContextMenu, this.soundShaper, this.touchToolbar,
    );
